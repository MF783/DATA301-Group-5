...
```
From the graph above, we can see that most crashes don't result in any injury. this is probably due tot he fact that most crashes occur when the speed limit is 50km/h or below and this is a relatively low speed. another reason for the high number of
