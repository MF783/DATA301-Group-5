...
```{r, fig.cap = 'The bar plot shows the number of fatalities categorized by primary weather conditions. It's clear that fatal car crashes are most likely to happen when the weather is fine. This is somewhat surprising considering it rains 111 days per year on average in New Zealand. However, it could be due to people driving more taking risks when the weather is better.'}
